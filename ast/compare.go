...
func (n *CallSubStmt) EqualsNode(node Node) Node {
	...
	res := n.Definition.EqualsNode(n2.Definition)
	if res != nil {
		return res
	}

	if n.CallKw.Equals(n2.CallKw) {
		return nil // found equal
	}
	return n
}
...
func (n *CallOrIndexExpr) EqualsNode(node Node) Node {
	...
	return n.Identifier.EqualsNode(n2.Identifier)
}
...
// EqualsNode returns true if the two nodes are equal.
func (n *CaseStmt) EqualsNode(node Node) Node {
	if n == nil && node == nil {
		return nil
	}
	if n == nil || node == nil {
...
func (n *ForStmt) EqualsNode(node Node) Node {
	...
	return n.ForExpression.EqualsNode(n2.ForExpression)
}
...
func (n *ForEachExpr) EqualsNode(node Node) Node {
	...
	return n.Variable.EqualsNode(n2.Variable)
}
...
func (n *ForNextExpr) EqualsNode(node Node) Node {
	...
	if n.Variable != nil {
		res := n.Variable.EqualsNode(n2.Variable)
		if res != nil {
			return res
		}
	} else {
...
// EqualsNode returns true if the two nodes are equal.
func (n *ClassDecl) EqualsNode(node Node) Node {
	panic("Not implemented")
}
