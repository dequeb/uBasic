...
type (
	...
	// A CaseExpr node represents a case expression.
	//
	// Examples.
	//
	//    Case 1
...
func (n *ExitStmt) String() string {
	...
	buf.WriteString(strcase.ToCamel(n.ExitType))
	return buf.String()
}
...
func (n *EnumDecl) String() string {
	...
	buf.WriteString(n.EnumName.String())
	buf.WriteString("\n")
...
func (n *ForStmt) String() string {
	buf := strings.Builder{}
	buf.WriteString("For ")
	buf.WriteString(n.ForExpr.String())
	buf.WriteString("\n")
	for _, stmt := range n.Body {
		buf.WriteString(stmt.String())
	}
...
// Token returns the first token of the Node
func (n *CaseExpr) Token() *token.Token {
	return n.CaseKw
}
...
// GetParent returns the parent node of the current node.
func (n *CaseExpr) GetParent() Node {
	return n.Parent
}
...
// SetParent sets the parent node of the current node.
func (n *CaseExpr) SetParent(node Node) {
	n.Parent = node
}
...
func (n *EnumDecl) Type() (types.Type, error) {
	typ := &types.UserDefined{Name: n.EnumName.Name}
	return typ, nil
}
