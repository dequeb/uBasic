...
func TypeOf(n ast.Expression) (types.Type, error) {
	...
	case *ast.CallOrIndexExpr:
		...
		default:
			return nil, errors.Newf(n.Lparen.Position, "cannot call non-function or non-array %q of type %q", n.Name, typ)
		}

	case *ast.Identifier:
		if n.Decl == nil {
			return &types.Basic{Kind: types.Long}, nil // assume enumed type -> Long
		}
		return n.Decl.Type()
	case *ast.ParenExpr:
